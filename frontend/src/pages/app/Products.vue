        ...
        <div class="my-4">
          <form @submit.prevent="addProduct" class="space-y-5">
            ...
            <div class="flex space-x-2 w-full">
              ...
              <div class="w-full">
                <TextField label="Stock" v-model.number="product.stock_quantity" placeholder="Stock Quantity" type="number"/>
              </div>
            </div>
            <div>
            ...
            <table class="table-auto w-full">
              <thead>
                <tr>
                  ...
                  <th class="border-[1px] border-yellow-600 px-3">STOCK</th>
              ...
              <tbody>
                <tr v-for="item, key in products" :key="key">
                  ...
                  <td class="border-[1px] border-yellow-600 px-3 w-[100px] ellipsis">{{ item.code }}</td>
                  <td class="border-[1px] border-yellow-600 px-3 ellipsis">{{ item.name }}</td>
                  <td class="border-[1px] border-yellow-600 px-3 w-[100px] text-right">{{ item.price.toLocaleString("en-US") }}</td>
                  <td class="border-[1px] border-yellow-600 px-3 w-[100px] text-right">{{ item.stock_quantity.toLocaleString("en-US") }}</td>
